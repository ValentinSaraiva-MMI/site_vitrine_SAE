...
<div class="hero_left" v-for="element in elements">
        <PrismicImage :field="element.hero_background_mobile" class="hero_backgroundmobile"/>
        ...
        <myButton class="hero_btn" url="/" size="big"  color="blue">Je m’inscris</myButton>
</div>

<p class="hero_backgrounddesktop">À VOS <br> MANETTES </p>
