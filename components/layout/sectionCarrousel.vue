  ...
  <section class="my_section section_carrousel">
    ...
    >
      <swiper-slide v-for="c in carrousel.data.carrousel_item">
        ...
        <PrismicRichText
          class="h2 carrousel_titre"
          :field="c.carrousel_titre"
        />
...
const { data: carrousel, error: carrousel_error } = await useAsyncData(
  "carrousel",
...
if (!carrousel.value || carrousel_error.value) {
  throw createError({
    statusCode: 404,
    statusMessage: "Prismic n'a pas trouvé la section carrousel",
  });
}
</script>
